...
class Ui_Tela_Autenticacao(object):
    ...
    def setupUi(self, Form):
        ...
        self.le_aut_cpf.setStyleSheet("background-color: #6C6C6C; color: white; padding: 5px; corner-radius: 10px; font-size: 12px; font-weight: bold; border-radius: 5px;")
        ...
        self.le_aut_senha.setStyleSheet("background-color: #6C6C6C; color: white; padding: 5px; corner-radius: 10px; font-size: 12px; font-weight: bold; border-radius: 5px;")
        ...
        self.btn_aut_confirmar.setStyleSheet("background-color: #333333; color: white; padding: 8px; font-weight: bold; font-size: 12px; border-radius: 8px")
        ...
        self.btn_aut_cancelar.setStyleSheet("background-color: #505050;; color: white; padding: 8px; font-weight: bold; font-size: 12px; border-radius: 8px")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_aut_confirmar.setText(_translate("Form", "Confirmar"))
